...
def blendDemo():
    im1 = cv2.cvtColor(cv2.imread('sunset.jpg'), cv2.COLOR_BGRA2RGB) / 255
    im2 = cv2.cvtColor(cv2.imread('cat.jpg'), cv2.COLOR_BGRA2RGB) / 255
    mask = cv2.cvtColor(cv2.imread('mask.jpg'), cv2.COLOR_BGRA2RGB) / 255
